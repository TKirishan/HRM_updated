...
const AllEmployees = () => {
  ...
  const generateEmployeeId = () => {
    const existingIds = employees.map((emp) => parseInt(emp.id.slice(-3)));
  ...
  const handleChange = (e) => {
    ...
    if (isEditing && editEmployee) {
      setEditEmployee({ ...editEmployee, [name]: newValue });
    } else {
              ...
              {employees
                ...
                .map((employee) => (
                  <tr key={employee.id}>
                    ...
                    <td>{employee.joiningDate}</td>
                    <td>{employee.role}</td>
                    <td>LKR {employee.basicSalary}</td>
                    <td>{employee.approveLoan ? "Yes" : "No"}</td>
                    <td>
                      {/* {new Date(employee.markingTime).toLocaleTimeString()} */}
                      <td>{employee.markingTime}</td>
                    </td>
                    <td>
                      <Dropdown drop="start">
                        <Dropdown.Toggle variant="secondary" size="sm">
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              <Form.Check
                ...
                checked={
                  isEditing
                    ? editEmployee?.approveLoan
                    : newEmployee.approveLoan
                }
                onChange={handleChange}
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              <Form.Label>Marking Time</Form.Label>
              <Form.Control
                type="time"
                name="markingTime"
                value={
                  isEditing
                    ? editEmployee?.markingTime
                    : newEmployee.markingTime
                }
                onChange={handleChange}
                required
              />
