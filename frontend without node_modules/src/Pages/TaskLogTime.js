...
// this for get current time in h:m am/pm format
...
const TaskLogTime = () => {
  ...
  // handle viewing completed task
  const handleViewTask = () => {
    alert("You have completed this task");
  };

  // show action buttons based on task status in the table
  const renderActionButton = (task) => {
    const buttonStyle = { width: "100px" }; //width for all buttons
