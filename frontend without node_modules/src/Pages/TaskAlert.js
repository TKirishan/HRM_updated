...
const TaskAlert = () => {
  ...
  const filteredAlerts = alerts.filter((alert) => {
    const filterInMessage = alert.message
      .toLowerCase()
      .includes(searchQuery.toLowerCase());
    const filterInId = alert.id
      .toLowerCase()
      .includes(searchQuery.toLowerCase());
    const filterInSubmittedBy = alert.submittedBy
      .toLowerCase()
      .includes(searchQuery.toLowerCase());
    return filterInMessage || filterInId || filterInSubmittedBy;
  });
